...
################################################################################
## Form generated from reading UI file 'forgotpassword_pagehQyyBc.ui'
##
...
"border-radius: 30px;")
        ...
        self.label_3.setGeometry(QRect(360, 90, 391, 81))
        font = QFont()
        ...
        self.emailLabel.setGeometry(QRect(420, 350, 260, 40))
        font1 = QFont()
...
"paddinf-bottom: 7px;")
        ...
        self.resetButton.setGeometry(QRect(450, 430, 191, 41))
        font2 = QFont()
...
"}")
        ...
        self.label_4.setGeometry(QRect(360, 240, 401, 71))
        font3 = QFont()
        ...
        self.label_5.setGeometry(QRect(360, 140, 391, 81))
        font4 = QFont()
        ...
        self.backToLoginButton.setGeometry(QRect(700, 50, 41, 41))
        self.backToLoginButton.setFont(font2)
        self.backToLoginButton.setStyleSheet(u"QPushButton{\n"
...
"")
        ...
        self.backToLoginButton.setIcon(icon)
        self.backToLoginButton.setIconSize(QSize(30, 30))
    ...
    def retranslateUi(self, Form):
        ...
        self.backToLoginButton.setText("")
    # retranslateUi
